...
<!-- ![ProjectScout Demo](./assets/demo-video.gif) -->
<!-- Or embed video: -->
<!-- <video src="./assets/projectscout-demo.mp4" controls width="100%"></video> -->
...
**ProjectScout** is an intelligent AI agent that helps developers find their next project.
...
<!-- TODO: Add feature highlights image -->
<!-- ![Key Features](./assets/features-overview.png) -->
...
<!-- Suggested: Create a visual diagram showing the flow from User -> FastAPI Server -> ProjectScoutAgent -> GitHub API -> LLM -> Response -->
...
<!-- TODO: Add screenshot of server running -->
...
<!-- TODO: Add API flow diagram -->
<!-- ![API Request/Response Flow](./assets/api-flow-diagram.png) -->
<!-- Suggested: Show the flow of a complete conversation with request/response examples -->
...
<!-- TODO: Add screenshot of example conversation -->
<!-- ![Example Conversation 1](./assets/conversation-example-1.png) -->
...
<!-- TODO: Add screenshot of project recommendations -->
<!-- ![Project Recommendations](./assets/project-recommendations.png) -->
...
<!-- TODO: Add screenshot of privacy-focused recommendations -->
<!-- ![Privacy Mode Example](./assets/privacy-mode-example.png) -->
...
<!-- TODO: Add infographic of advanced rules -->
<!-- ![Advanced Rules Overview](./assets/advanced-rules-infographic.png) -->
<!-- Suggested: Visual representation of how the 11 rules work together -->
...
<!-- ![Deployment Options](./assets/deployment-diagram.png) -->
